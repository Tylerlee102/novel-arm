...
| G15. Area/resource/timing synthesis | Yes | PARTIAL | research/results/synthesis.csv; research/results/synthesis_overhead.csv; research/results/fullcore_synthesis.csv; research/results/fullcore_synthesis_overhead.csv | Matched unit-level and near-core-stub resource rows exist; mapped timing/power requires real reports | No full-core or mapped near-core timing/power report exists; generic Yosys cells are resource evidence only. |
