#!/usr/bin/env python3
"""Cross-build an OpenSSL EVP/HMAC crypto-suite workload for ARM64 gem5 runs."""
...
SRC = ROOT / "research" / "aarch64_openssl_crypto_suite_workload.c"
OUT = ROOT / "research" / "bin" / "aarch64_openssl_crypto_suite_workload"
LOG_DIR = ROOT / "research" / "results" / "openssl_crypto_suite_workload_build"
...
def main() -> None:
    ...
    lines = [
        "# OpenSSL Crypto-Suite Workload AArch64 Build",
        "",
    ...
    (LOG_DIR / "OPENSSL_CRYPTO_SUITE_WORKLOAD_BUILD.md").write_text(
