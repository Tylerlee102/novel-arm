...
& $Vivado -mode batch `
    -log research\results\copper_clpd_sram_dir_synth_sweep.log `
    -journal research\results\copper_clpd_sram_dir_synth_sweep.jou `
    -source research\run_copper_clpd_sram_dir_synth_sweep.tcl
exit $LASTEXITCODE
