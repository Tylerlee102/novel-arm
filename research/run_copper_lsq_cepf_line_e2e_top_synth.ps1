...
& $Vivado -mode batch `
    -log research\results\copper_lsq_cepf_line_e2e_top_synth.log `
    -journal research\results\copper_lsq_cepf_line_e2e_top_synth.jou `
    -source research\run_copper_lsq_cepf_line_e2e_top_synth.tcl
exit $LASTEXITCODE
