...
& $Vivado -mode batch `
    -log research\results\copper_clpd_sram_dir_synth.log `
    -journal research\results\copper_clpd_sram_dir_synth.jou `
    -source research\run_copper_clpd_sram_dir_synth.tcl
exit $LASTEXITCODE
