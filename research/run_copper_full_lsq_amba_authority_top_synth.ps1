...
& "$VivadoBin\vivado.bat" -mode batch -source research\run_copper_full_lsq_amba_authority_top_synth.tcl -journal research\results\copper_full_lsq_amba_authority_top_synth.jou -log research\results\copper_full_lsq_amba_authority_top_synth.log
exit $LASTEXITCODE
