...
& $Vivado -mode batch `
    -log research\results\copper_amba_sari_frontdoor_synth.log `
    -journal research\results\copper_amba_sari_frontdoor_synth.jou `
    -source research\run_copper_amba_sari_frontdoor_synth.tcl
exit $LASTEXITCODE
