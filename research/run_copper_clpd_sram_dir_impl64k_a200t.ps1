...
& $Vivado -mode batch `
    -log research\results\copper_clpd_sram_dir_impl64k_a200t.log `
    -journal research\results\copper_clpd_sram_dir_impl64k_a200t.jou `
    -source research\run_copper_clpd_sram_dir_impl64k_a200t.tcl
exit $LASTEXITCODE
