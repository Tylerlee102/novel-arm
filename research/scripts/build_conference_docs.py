...
def gate_status() -> list[dict[str, str]]:
    ...
    return [
        ...
        gate("G19. Paper build", "Yes", "PASS" if paper_built else "BLOCKED", "research/paper/main.tex; research/results/paper_build_status.csv", "PDF builds in GitHub Actions, Docker, or Codespaces", "No CI/Docker/Codespaces paper PASS row has been collected yet."),
