...
def gem5_raw_stats_summary() -> str:
    ...
    if not rows:
        return "no repeated fresh raw gem5 statistics"
    ...
    return (
        f"{len(rows)} repeated fresh raw gem5 statistic rows across "
