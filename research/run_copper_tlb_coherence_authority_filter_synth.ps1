...
& "$VivadoBin\vivado.bat" -mode batch -source research\run_copper_tlb_coherence_authority_filter_synth.tcl -journal research\results\copper_tlb_coherence_authority_filter_synth.jou -log research\results\copper_tlb_coherence_authority_filter_synth.log
exit $LASTEXITCODE
