    ...
    checks = [
        ...
        contains(
            ...
            [
                ...
                "Process-mode rows: 1; process TCP pairs: 5; child failures: 0.",
        ...
        contains(
            ...
            [
                ...
                "Process-mode rows: 1; process TCP pairs: 20; child failures: 0.",
                "status=TCP_NETNS_PROCESS_PASS",
            ],
        ),
        contains(
        ...
        contains(
            ...
            [
                ...
                "Process-mode rows: 1; process TCP pairs: 40; child failures: 0.",
                "status=TCP_NETNS_PROCESS_PASS",
            ],
        ),
        contains(
