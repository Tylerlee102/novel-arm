...
- Minimal-package bytes: 6,206,355
...
| reproduction_script | 274 | 1,664,657 |
...
| include-in-minimal-package | 585 | 6,206,355 | Small or central artifacts that should be copied directly into a public package. |
