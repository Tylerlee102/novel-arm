...
- Minimal-package bytes: 6,206,611
...
| include-in-minimal-package | 585 | 6,206,611 | Small or central artifacts that should be copied directly into a public package. |
