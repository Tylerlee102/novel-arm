...
| Bus overhead | `research/results/figures/copper_app_bus_overhead.png` | `research/results/figures/copper_app_bus_overhead.svg` | Shows standalone COPPER memory-bus byte deltas versus no prefetching. |
