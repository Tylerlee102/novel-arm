...
| C7 | COPPER has matched unit-level generic-synthesis overhead. | TODO | research/results/synthesis.csv; research/results/synthesis_overhead.csv | unit synthesis | Allowed only if an open-environment Yosys flow produced matched overhead rows; not full-core overhead. |
