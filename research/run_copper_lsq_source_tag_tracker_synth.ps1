...
& $Vivado -mode batch `
    -log research\results\copper_lsq_source_tag_tracker_synth.log `
    -journal research\results\copper_lsq_source_tag_tracker_synth.jou `
    -source research\run_copper_lsq_source_tag_tracker_synth.tcl
exit $LASTEXITCODE
