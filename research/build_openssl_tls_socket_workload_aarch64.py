#!/usr/bin/env python3
"""Cross-build an OpenSSL libssl socket-backed TLS workload for ARM64 gem5 runs."""
...
SRC = ROOT / "research" / "aarch64_openssl_tls_socket_workload.c"
OUT = ROOT / "research" / "bin" / "aarch64_openssl_tls_socket_workload"
LOG_DIR = ROOT / "research" / "results" / "openssl_tls_socket_workload_build"
...
def main() -> None:
    ...
    (LOG_DIR / "OPENSSL_TLS_SOCKET_WORKLOAD_BUILD.md").write_text(
