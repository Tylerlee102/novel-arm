#!/usr/bin/env python3
"""Cross-build an OpenSSL libssl TCP-Loopback TLS workload for ARM64 gem5 runs."""
...
SRC = ROOT / "research" / "aarch64_openssl_tls_tcp_workload.c"
OUT = ROOT / "research" / "bin" / "aarch64_openssl_tls_tcp_workload"
LOG_DIR = ROOT / "research" / "results" / "openssl_tls_tcp_workload_build"
...
def main() -> None:
    ...
    lines = [
        "# OpenSSL TLS TCP Loopback Workload AArch64 Build",
        "",
        ...
        "nonblocking Linux TCP loopback connection while maintaining session hash/LRU metadata and",
    ...
    (LOG_DIR / "OPENSSL_TLS_TCP_WORKLOAD_BUILD.md").write_text(
