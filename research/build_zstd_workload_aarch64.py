#!/usr/bin/env python3
"""Cross-build a Zstd workload for ARM64 gem5 full-system runs."""
...
SRC = ROOT / "research" / "aarch64_zstd_workload.c"
OUT = ROOT / "research" / "bin" / "aarch64_zstd_workload"
LOG_DIR = ROOT / "research" / "results" / "zstd_workload_build"


def main() -> None:
    OUT.parent.mkdir(parents=True, exist_ok=True)
    LOG_DIR.mkdir(parents=True, exist_ok=True)
    lib = SYSROOT / "usr" / "lib" / "aarch64-linux-gnu" / "libzstd.so.1.5.5"
    cmd = [
        str(CLANG),
    ...
    (LOG_DIR / "ZSTD_WORKLOAD_BUILD.md").write_text(
